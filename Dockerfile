...
# docker build --no-cache -t us-central1-docker.pkg.dev/mchirico/public/activeincident:v0.0.19 -f Dockerfile .
# docker push us-central1-docker.pkg.dev/mchirico/public/activeincident:v0.0.19 
